...
function EditAddressModal({name}:{name:String}) {
    return (
        <MyRequestForm>
            <Heading slot="title" className="col-span-2 flex justify-left text-2xl pt-8 pb-4">Edit Shipping Address {name}</Heading>
